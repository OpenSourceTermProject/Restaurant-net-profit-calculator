...
class Tax(Widget):
    def __init__(self, **kwargs):
        super(Tax, self).__init__(**kwargs)

    def CalcTax(self, year_total_income, total_necessary_expenses):
        ...
        if income <= 14000000:  # 1,400만원 이하
            tax = income * 0.06
        elif income <= 46000000:  # 1,400만원 초과 ~ 5,000만원 이하
