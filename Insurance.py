def Insurance(year_total_income, necessary_expenses, employment_insurance, industrial_accident_insurance, multi_insurance, disaster_insurance, gas_insurance):
